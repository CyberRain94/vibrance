...
export default [
  ...
  riseTwoSitting,
  riseThreeSunrise,
  riseFourBlueMountainSky,
  starShoppingOneRetroCamp,
  starShoppingTwoSnowAurora,
  starShoppingThreeVacuum,
  starShoppingFourBeacon,
  wanderlustOnePurpleSky,
  wanderlustTwoJungleRiver,
  wanderlustThreePinkWave,
  wanderlustFourMountainReflection,
  stockImagesOneAquaLake,
